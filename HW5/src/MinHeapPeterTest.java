...
public class MinHeapPeterTest {
    ...
    private boolean printBackingArray;  //So if a test fails we print the array

    @Before
    public void setUp() {
        minHeap = new MinHeap<>();
        printBackingArray = true;
    }

    @After
    public void printHeapArray() {
        if (printBackingArray) {
            Object[] backingArray = minHeap.getBackingArray();

            System.out.println("Backing array when test failed: ");
            System.out.print("{");
